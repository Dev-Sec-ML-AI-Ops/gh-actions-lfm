...
async function run() {
  ...
  try {
    ...
    if (!validateDirectoryName({ dirName: workingDir })) {
      core.setFailed(
        'Invalid working directory name. Directory names should include only characters, numbers, hyphens, underscores, dots, and forward slashes.'
      );
      return;
    }
...
/*
  ...
  2. Execute he npm update command within the working directory
  3. Check whether ther  are  mmodified package*.json files
